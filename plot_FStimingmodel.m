...
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/FStimingmodel/',...
    'spk_0.txt'));
...
for trial = 1:sim_trials
    ...
    % load simulation
    trial_simulation = load(strcat(pwd,'/HNN_sims/FStimingmodel/',...
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/FStimingmodel/dpl.txt'));
