...
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/FSinitsomaticinhibmodel/',...
    'spk_0.txt'));
...
for trial = 1:sim_trials
    ...
    % load simulation
    trial_simulation = load(strcat(pwd,'/HNN_sims/FSinitsomaticinhibmodel/',...
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/FSinitsomaticinhibmodel/dpl.txt'));
