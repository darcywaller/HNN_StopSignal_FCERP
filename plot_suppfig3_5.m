...
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/supp figs/SSmodel_p2n2_50/',...
    'spk_0.txt'));
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/supp figs/SSmodel_p2n2_50/',...
    'dpl.txt'));
...
% p3 only
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/supp figs/SSmodel_p3only_50/',...
    'spk_0.txt'));
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/supp figs/SSmodel_p3only_50/',...
    'dpl.txt'));
simulation_time = simulation(:,1); % time
simulation_agg = simulation(:,2); % aggregate dipole
simulation_L2 = simulation(:,3); % layerII/III dipole
...
% SS opt one spike
simulation_p2n2 = load(strcat(pwd,'/HNN_sims/supp figs/SSmodel_p2n2_50/',...
    'dpl.txt'));
...
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/supp figs/FStimingmodel_p2n2_only/',...
    'spk_0.txt'));
% from param.txt, identities of drives and spikes - these can be found in
% the first 8 lines of the param .txt file
L5_pyr = [ 170,  269];
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/supp figs/FStimingmodel_p2n2_only/',...
    'dpl.txt'));
simulation_time = simulation(:,1); % time
simulation_agg = simulation(:,2); % aggregate dipole
simulation_L2 = simulation(:,3); % layerII/III dipole
...
% p3 only
% data
trial_spikes = load(strcat(pwd,'/HNN_sims/supp figs/FStimingmodel_p3_only/',...
    'spk_0.txt'));
...
% load simulation
simulation = load(strcat(pwd,'/HNN_sims/supp figs/FStimingmodel_p3_only/',...
    'dpl.txt'));
simulation_time = simulation(:,1); % time
simulation_agg = simulation(:,2); % aggregate dipole
simulation_L2 = simulation(:,3); % layerII/III dipole
...
% SS opt one spike
simulation_p2n2 = load(strcat(pwd,'/HNN_sims/supp figs/FStimingmodel_p2n2_only/'...
    'dpl.txt'));
simulation_agg_p2n2 = simulation_p2n2(:,2); % aggregate dipole
simulation_both = simulation_agg+simulation_agg_p2n2;
